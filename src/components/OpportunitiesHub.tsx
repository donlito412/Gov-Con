                  ...
                  <TableBody>
                    {filteredItems.map((opp, i) => (
                      <TableRow key={i} className="group border-b border-border/40 hover:bg-primary/5 transition-colors">
                        <TableCell className="pl-6 py-4">
                          <div className="space-y-1.5">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {opp.tags.map((tag, j) => (
                                <Badge key={j} variant="outline" className="text-[9px] font-medium px-1.5 py-0 bg-background/50 border-border/50 text-muted-foreground group-hover:border-primary/30 transition-colors">
                                  {tag}
                                </Badge>
                              ))}
                            </div>
                        ...
                        <TableCell className="text-xs font-semibold text-muted-foreground group-hover:text-foreground transition-colors">{opp.agency}</TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-right pr-6">
                          <Button variant="ghost" size="sm" className="h-8 px-4 text-xs hover:bg-primary hover:text-white transition-all group-hover:translate-x-1">
